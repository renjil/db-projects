"""
Agent for Databricks AI Functions. Matches https://github.com/databricks/tmm agents-workshop.
Cluster must have: databricks-openai, mlflow-skinny[databricks], openai (run agent_setup first).
"""
import json
...
VECTOR_SEARCH_TOOLS.append(
    VectorSearchRetrieverTool(
        ...
        num_results=1,
        columns=["product_id", "product_name", "product_doc"],
        disable_notice=True)
    )
